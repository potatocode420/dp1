...
static class UtilityFunctions
{
	...
	private static readonly Color SMALL_MISS = SwinGame.RGBAColor(208, 158, 98, 255);
	...
	private static readonly Color LARGE_MISS = SwinGame.RGBAColor(37, 148, 32, 255);
	...
	public static void DrawBackground()
	{
		switch (GameController.CurrentState) {
			...
			case GameState.Instructions:
				SwinGame.DrawBitmap(GameResources.GameImage("Water"), 0, 0);
				break;
			default:
